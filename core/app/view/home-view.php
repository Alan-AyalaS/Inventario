                        ...
                        <div class="col-6 col-lg-3">
                            <div class="card">
                                ...
                                <div class="card-footer px-3 py-2">
                                    <a class="btn-block text-medium-emphasis d-flex justify-content-between align-items-center" href="./?view=inventary">
                                        <span class="small fw-semibold">IR A INVENTARIO</span>
                                        <svg class="icon">
