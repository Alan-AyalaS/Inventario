...
<button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#adminDebugModal" style="position: fixed; bottom: 20px; right: 20px; z-index: 9999;">
    <i class="cil-bug"></i> Debug Admin
</button>
