...
$sheet->setCellValue('C1', 'Precio de Entrada');
$sheet->setCellValue('D1', 'Precio de Salida');
$sheet->setCellValue('E1', 'Unidad');
$sheet->setCellValue('F1', 'Disponible');
$sheet->setCellValue('G1', 'Mínima en Inventario');
...
foreach($products as $product) {
    ...
    $sheet->setCellValue('G' . $row, $product->inventary_min);
...
header('Content-Disposition: attachment;filename="inventario_productos_' . $current_datetime . '.xlsx"');
